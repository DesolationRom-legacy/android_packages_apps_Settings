...
public class LockWeather extends SettingsPreferenceFragment
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.lock_weather);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        LockWeather getOwner() {
            return (LockWeather) getTargetFragment();
        }
